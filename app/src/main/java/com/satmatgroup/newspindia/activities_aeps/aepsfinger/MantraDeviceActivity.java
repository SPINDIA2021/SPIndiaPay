            ...
            case R.id.btnCapture:
                try {
                  ...
                  /*  aepsTransaction(rtid, resutSend, "418869728175", "",
                    ...
                    aepsTransaction(rtid, resultSend, "418869728175", "508534",
                            "9799754037", transactionType, sendAmount, latitude,
                            longitude);*/
                   /* callServiceSave(rtid, resultSend, "418869728175", "508534",
                            "9799754037", transactionType, sendAmount, latitude,
                            longitude);*/
    ...
    public void onAPICallCompleteListner(@Nullable Object item, @Nullable String flag, @NotNull String result) throws JSONException {
        if (flag.equals(AEPS_TRANSACTION)) {
         ...
         //  Toast.makeText(this, "AEPS_TRANSACTION : "+result , Toast.LENGTH_SHORT).show();
            ...
            String aepsmessage = jsonObject1.getString(AppConstants.MESSAGE);
                ...
                if (transactionType.equals("aepstwofactorregistration"))
                    if (transactionType.equals("aepstwofactorregistration"))
                    {
                        ...
                        try{
                            ...
                            Toast.makeText(MantraDeviceActivity.this, jsonObject.getString("message").toString(), Toast.LENGTH_SHORT).show();
                        ...
                        JSONObject jsonObject = jsonObject1.getJSONObject("data");
                        Toast.makeText(MantraDeviceActivity.this, jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
