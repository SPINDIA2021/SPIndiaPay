...
import com.satmatgroup.newspindia.activities_aeps.aepsfinger.AepsBankModel
import com.satmatgroup.newspindia.activities_aeps.aepsfinger.BankAepsListAdapter
import com.satmatgroup.newspindia.activities_aeps.aepsfinger.MantraDeviceActivity
import com.satmatgroup.newspindia.aeps_activities.AepsTransactionBankAdapterNew
...
class AepsTwoFactorAuthenticationActivity : AppCompatActivity(), BankAepsListAdapter.ListAdapterListener,
    ...
    var pidData: String = ""
    var transactionType: String = "aepstwofactorregistration"
