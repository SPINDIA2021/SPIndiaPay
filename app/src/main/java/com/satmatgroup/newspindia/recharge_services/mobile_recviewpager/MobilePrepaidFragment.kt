package com.satmatgroup.newspindia.recharge_services.mobile_recviewpager
...
import com.satmatgroup.newspindia.network_calls.AppApiUrl.IMAGE_URL
...
import com.satmatgroup.newspindia.utils.AppConstants.Companion.OPERATOR_API
import com.satmatgroup.newspindia.utils.AppConstants.Companion.OPERATOR_MOBILE
...
class MobilePrepaidFragment : Fragment(), AppApiCalls.OnAPICallCompleteListener,
            ...
            if (!AppCommonMethods.checkForMobile(view.etMobileNumberPrepaid)) {
                ...
                if (view.etAmountPrepaid.text.isNullOrEmpty()) {
                    ...
                    checkIfSameRecharge(
                        ...
                        view.etAmountPrepaid.text.toString(), userModel.logintype
                    )
    ...
    override fun onAPICallCompleteListner(item: Any?, flag: String?, result: String) {
        ...
        if (flag.equals(AppConstants.CHECK_SAME_RECHARGE_API)) {
            ...
            if (status.contains("true")) {
                root.progress_bar.visibility = View.GONE
                verifyPin(userModel.mobile, AppPrefs.getStringPref("AppPassword",context).toString())
            //confirmPinDialog()
        ...
        if (flag.equals(AppConstants.VERFY_PIN_API)) {
            ...
            if (status.contains(AppConstants.TRUE)) {
                root.progress_bar.visibility = View.GONE
                rechargeApi(
                    userModel.rtid, root.etMobileNumberPrepaid.text.toString(),
                    root.etAmountPrepaid.text.toString(), operator_code, userModel.logintype
                )
