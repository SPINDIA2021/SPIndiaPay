...
import com.satmatgroup.newspindia.adapters_recyclerview.CommisionSlabadapter
import com.satmatgroup.newspindia.model.CommisionSlabModel
...
class CommissionSlabActivity : AppCompatActivity(), AppApiCalls.OnAPICallCompleteListener,
    ...
    private fun commisionApi(
        ...
        if (AppCommonMethods(this).isNetworkAvailable) {
            ...
            mAPIcall.commisionSlab(rtid,deviceId ,deviceName,pin,
